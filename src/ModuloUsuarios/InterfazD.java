...
public class InterfazD extends javax.swing.JFrame {
    ...
    Principal menu;
          ...
          String elemento;
          Interfaz es = new Interfaz();
          GestorTareas docente= new GestorTareas();
    public InterfazD() {
        initComponents();
        es.dispose();
        try {
            ...
            elemento=mp.verFuncion("docente");
            JMenuItem item=new JMenuItem(elemento);
            funciones.add(item);
            InterfazD.Hilo hiloHora = new InterfazD.Hilo();// Creacion de Hilo para reloj
            hiloHora.start(); //Inicializacionde Hilo para r
            ...
            Logger.getLogger(InterfazD.class.getName()).log(Level.SEVERE, null, ex);
